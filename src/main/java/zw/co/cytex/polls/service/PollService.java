package zw.co.cytex.polls.service;
...
import org.springframework.stereotype.Service;
import zw.co.cytex.polls.exception.BadRequestException;
import zw.co.cytex.polls.exception.ResourceNotFoundException;
import zw.co.cytex.polls.model.*;
import zw.co.cytex.polls.payload.PagedResponse;
import zw.co.cytex.polls.payload.PollRequest;
import zw.co.cytex.polls.payload.PollResponse;
import zw.co.cytex.polls.payload.VoteRequest;
import zw.co.cytex.polls.repository.PollRepository;
import zw.co.cytex.polls.repository.UserRepository;
import zw.co.cytex.polls.repository.VoteRepository;
import zw.co.cytex.polls.security.UserPrincipal;
import zw.co.cytex.polls.util.AppConstants;
import zw.co.cytex.polls.util.ModelMapper;
